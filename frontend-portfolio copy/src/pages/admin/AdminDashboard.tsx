...
import { LayoutDashboard, FileText, Briefcase, Mail, Settings, Users, MessageSquare, Menu } from 'lucide-react';
...
// import { motion } from 'framer-motion';
// import { useAuth } from '../../contexts/AuthContext';
// import { LayoutDashboard, FileText, Briefcase, Mail, Image, Settings, Users, MessageSquare, Menu } from 'lucide-react';
// import { GlassCard } from '../../components/GlassCard';
...
//     { name: 'Team', icon: Users, href: '/admin/team' },
//     { name: 'Testimonials', icon: MessageSquare, href: '/admin/testimonials' },
//     { name: 'Menus', icon: Menu, href: '/admin/menus' }, // Add this
//     { name: 'Settings', icon: Settings, href: '/admin/settings' }
//   ];
